...
let createBundle = async function (resourceData, res) {
    try {

        let bundle = resourceData.bundle;
...
module.exports = { createBundle, patchBundle, deleteBundle, getBundleJSON, mapBundleService }